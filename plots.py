...
def plotmapa(mapa, ns, ms, norm=None, npeaks=3, title='', fig=None):
    ...
    # mapa=mapa.T
    if fig is None:
        fig  = plt.figure(figsize=[9,6], constrained_layout=False, tight_layout=False, dpi=100)
    gs = gridspec.GridSpec(2, 4, wspace=0.1, hspace=0.1,
                           width_ratios=[8,2,0.5,0.3], height_ratios=[4,1])
